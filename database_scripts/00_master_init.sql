...
-- ==========================================
-- FAILSAFE: ALTER TABLES PARA ACTUALIZACIONES DE ESQUEMA
-- ==========================================
-- Estas sentencias aseguran que si las tablas ya exist�an antes de a�adir
-- estas columnas, se agreguen correctamente al ejecutar este script maestro.
